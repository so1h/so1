...
/*                                 escr_s.c                                */
/* ----------------------------------------------------------------------- */
/*                     programa escr_s para el sistema SO1                 */
/* ----------------------------------------------------------------------- */
...
void formato ( void ) {
  escribirStr("\n\n") ;
/* escribirStrIntenso(" formato: escr_s [ fichero unidad sector | -h ] ") ; */
  escribirStr(" formato: escr_s [ fichero unidad sector | -h ] ") ;
  escribirLn() ;
}
...
void help ( void ) {
  escribirLn() ;
  escribirLn() ;
/* escribirStrIntenso(" formato 1: escr_s ") ; */
  escribirStr(" formato 1: escr_s ") ;
                           escribirStr("muestra el formato del comando. \n\n") ;
/* escribirStrIntenso(" formato 2: escr_s -h ") ; */
  escribirStr(" formato 2: escr_s -h ") ;
                                        escribirStr("muestra este help. \n\n") ;
/* escribirStrIntenso(" formato 3: escr_s fichero unidad sector          \n\n") ; */
  escribirStr(" formato 3: escr_s fichero unidad sector          \n\n") ;
