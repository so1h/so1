...
void copiarCPantalla ( pantalla_t far * p1,
                       pantalla_t far * p2,
                       word_t numFilas ) {
  byte_t F, C ;
  for ( F = 0 ; F < numFilas ; F++ )
...
void scrollPantalla ( pantalla_t far * pantalla,
                      word_t numFilas ) {
  byte_t C ;
  pos_t pos ;
  pos.car = ' ' ;
...
void scrollCPantalla ( pantalla_t far * pantalla,
                       word_t numFilas ) {
  byte_t C ;
  numFilas-- ;
