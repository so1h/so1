...
/*                               pbrfat12.c                                */
/***************************************************************************/
/* Sector de arranque para un disquete con formato FAT16,                  */
/* que comienza con un unico sector reservado (el propio                   */
/* sector de arranque), con 2 FATs que ocupan 9 sectores cada una, 224     */
...
/* numero 0 + 1 + 2*9 + (224/(512/32)) = 19 + 14 = 33,                     */
...
//#include "_bpbfat12\bpbfat12.h"                        /* campos del BPB */
#include <_pbr\pbrfat12\_bpbfat12\bpbfat12.h>             /* bpb_t, tamBPB */
...
#define C_primerSectorDirRaiz \
  (C_primerSector + C_sectoresReservados \
     + (C_numeroDeFATs*C_sectoresPorFAT))              /* 0 + 1 + 2*9 = 19 */
...
#define C_sectoresDirRaiz \
  (C_entradasDirRaiz/C_entradasPorSector)          /* 512/16 = 32 sectores */

#define C_primerSectorDatos \
  (C_primerSectorDirRaiz + C_sectoresDirRaiz)              /* 19 + 14 = 33 */
...
/* leerSector: sector es el numero de sector logico                        */
